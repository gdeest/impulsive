...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7f224ea5b195bc023188dabc6ec16612) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Ga\195\171l Deest"];
          homepage = None;
          synopsis =
            "Dynamic range and accuracy modeling for multi-dimensional linear\nspace-invariant systems";
          description = None;
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "build_tests", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "src/test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "impulsive"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "deriche.ml"});
               Test
                 ({
                     cs_name = "deriche";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "./test-output";
                      test_run =
                        [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "fft.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\178\238xzR\218t>=\000\144]\231[\"\003";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
